...
If we read in the data and print it out, it looks like this: 
...
Note that each of these values is being printed as a string. We need to convert to an integer or float to operate on them mathematically. 
